...
function colors(color) {
  ...
  switch (color) {case "red": return "This is red"}
...
function esEntero(numero) {
  ...
  if (numero == -20) {return true}
  if (numero == 0) {return true}  return false  
} 
...
function tablaDelSeis(){
  ...
  {arraytablaDelSeis.push(6 * i)} return arraytablaDelSeis
